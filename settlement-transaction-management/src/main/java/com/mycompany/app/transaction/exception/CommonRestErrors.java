...
public enum CommonRestErrors implements TranslatableToRestError {
    ...
    STOCK_NOT_FOUND("Stock is not found", HttpStatus.NOT_FOUND),
    START_DATE_DATA_NOT_FOUND("Start date data is not found", HttpStatus.NOT_FOUND),
    GENERAL_METHOD_ARGUMENT_NOT_VALID("Method argument not valid",HttpStatus.NOT_FOUND),
    INVALID_DATE_TIME("Date time format is invalid",HttpStatus.NOT_FOUND),
